...
CdkInfraStack(app, "PaviPipelineCdkStack", env=agr_aws_environment)

CdkInfraStack(
    app,
    "PaviPipelineCdkStack-dev",
    env_suffix="dev",
...
StepFunctionsPocStack(
    app,
    "PaviStepFunctionsStack-staging",
    env_suffix="staging",
    shared_logs_group="pavi/pipeline-batch-jobs",
    shared_work_dir_bucket="agr-pavi-pipeline-nextflow",
    env=agr_aws_environment,
