...
def test_seq_embedded_variants_list_initiation(
    wb_variant_yn32_in_C42D8_8a_1_coding_seq,
) -> None:
    embedded_variants_list = SeqEmbeddedVariantsList(
        [wb_variant_yn32_in_C42D8_8a_1_coding_seq]
    )
...
def test_shift_rel_positions_forwards(wb_variants_yn10_yn30_in_C42D8_8a_1_list) -> None:
    ...
    for key in range(len(list_copy)):
        assert (
            list_copy[key].seq_start_pos
            == wb_variants_yn10_yn30_in_C42D8_8a_1_list[key].seq_start_pos + 2
        )
        assert (
            list_copy[key].seq_end_pos
            == wb_variants_yn10_yn30_in_C42D8_8a_1_list[key].seq_end_pos + 2
        )


def test_shift_rel_positions_backwards(
    wb_variants_yn10_yn30_in_C42D8_8a_1_list,
) -> None:
    list_copy = deepcopy(wb_variants_yn10_yn30_in_C42D8_8a_1_list)
    ...
    for key in range(len(list_copy)):
        assert (
            list_copy[key].seq_start_pos
            == wb_variants_yn10_yn30_in_C42D8_8a_1_list[key].seq_start_pos - 1
        )
        assert (
            list_copy[key].seq_end_pos
            == wb_variants_yn10_yn30_in_C42D8_8a_1_list[key].seq_end_pos - 1
        )


def test_trimmed_on_rel_positions_deletion_edge(
    wb_variants_yn10_yn30_in_C42D8_8a_1_list,
) -> None:
    """
    Test trimming at the deletion's edge (should drop the deletion from the list)
    """
    trimmed_list = SeqEmbeddedVariantsList.trimmed_on_rel_positions(
        wb_variants_yn10_yn30_in_C42D8_8a_1_list, 172
    )
...
def test_trimmed_on_rel_positions_between_variants(
    wb_variants_yn10_yn30_in_C42D8_8a_1_list,
) -> None:
    """
    ...
    """
    trimmed_list = SeqEmbeddedVariantsList.trimmed_on_rel_positions(
        wb_variants_yn10_yn30_in_C42D8_8a_1_list, 150
    )
...
def test_trimmed_on_rel_positions_last_variant_boundary(
    wb_variants_yn10_yn30_in_C42D8_8a_1_list,
) -> None:
    """
    ...
    """
    trimmed_list = SeqEmbeddedVariantsList.trimmed_on_rel_positions(
        wb_variants_yn10_yn30_in_C42D8_8a_1_list, 173
    )
...
def test_trimmed_on_rel_positions_outside_list_boundary(
    wb_variants_yn10_yn30_in_C42D8_8a_1_list,
) -> None:
    """
    ...
    """
    trimmed_list = SeqEmbeddedVariantsList.trimmed_on_rel_positions(
        wb_variants_yn10_yn30_in_C42D8_8a_1_list, 180
    )
