...
@pytest.fixture
def wb_variants_ok2799_in_k12g11_3_1_coding_seq(wb_variant_ok2799) -> SeqEmbeddedVariant:
    return SeqEmbeddedVariant(variant=wb_variant_ok2799, seq_start_pos=240, seq_end_pos=241,
                              embedded_ref_seq_len=549, embedded_alt_seq_len=0)
