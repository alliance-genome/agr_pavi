...
def test_seq_embedded_variant_initiation(
    wb_variant_yn32_in_C42D8_8a_1_coding_seq, wb_variant_yn32
) -> None:
    ...
    assert (
        wb_variant_yn32_in_C42D8_8a_1_coding_seq.variant_id
        == wb_variant_yn32.variant_id
    )


def test_seq_embedded_variant_initiation_from_dict(
    wb_variant_yn32_in_C42D8_8a_1_coding_seq, wb_variant_yn32
) -> None:
...
def test_translation_of_substitution(wb_variant_yn32_in_C42D8_8a_1_coding_seq) -> None:
    ...
    translated_wb_variant_yn32_in_C42D8_8a_1_coding_seq = (
...
def test_translation_of_insertion_between_codons() -> None:
    ...
    """
    one_bp_insertion_variant = Variant(
        "test-1bp-insertion", "X", 5116861, 5116862, genomic_alt_seq="G"
    )
    one_bp_insertion = SeqEmbeddedVariant(
        variant=one_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=4,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=1,
    )
    ...
    two_bp_insertion_variant = Variant(
        "test-2bp-insertion", "X", 5116861, 5116862, genomic_alt_seq="GG"
    )
    two_bp_insertion = SeqEmbeddedVariant(
        variant=two_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=5,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=2,
    )
    ...
    three_bp_insertion_variant = Variant(
        "test-3bp-insertion", "X", 5116861, 5116862, genomic_alt_seq="GGG"
    )
    three_bp_insertion = SeqEmbeddedVariant(
        variant=three_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=6,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=3,
    )
    ...
    four_bp_insertion_variant = Variant(
        "test-4bp-insertion", "X", 5116861, 5116862, genomic_alt_seq="GGGG"
    )
    four_bp_insertion = SeqEmbeddedVariant(
        variant=four_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=7,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=4,
    )
    ...
    five_bp_insertion_variant = Variant(
        "test-5bp-insertion", "X", 5116861, 5116862, genomic_alt_seq="GGGGG"
    )
    five_bp_insertion = SeqEmbeddedVariant(
        variant=five_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=8,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=5,
    )
    ...
    six_bp_insertion_variant = Variant(
        "test-6bp-insertion", "X", 5116861, 5116862, genomic_alt_seq="GGGGGG"
    )
    six_bp_insertion = SeqEmbeddedVariant(
        variant=six_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=9,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=6,
    )
...
def test_translation_of_insertion_one_bp_in_codon() -> None:
    ...
    """
    one_bp_insertion_variant = Variant(
        "test-1bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="G"
    )
    one_bp_insertion = SeqEmbeddedVariant(
        variant=one_bp_insertion_variant,
        seq_start_pos=5,
    ...
    two_bp_insertion_variant = Variant(
        "test-2bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GG"
    )
    two_bp_insertion = SeqEmbeddedVariant(
        variant=two_bp_insertion_variant,
        seq_start_pos=5,
    ...
    three_bp_insertion_variant = Variant(
        "test-3bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GGG"
    )
    three_bp_insertion = SeqEmbeddedVariant(
        variant=three_bp_insertion_variant,
        seq_start_pos=5,
    ...
    four_bp_insertion_variant = Variant(
        "test-4bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GGGG"
    )
    four_bp_insertion = SeqEmbeddedVariant(
        variant=four_bp_insertion_variant,
        seq_start_pos=5,
    ...
    five_bp_insertion_variant = Variant(
        "test-5bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GGGGG"
    )
    five_bp_insertion = SeqEmbeddedVariant(
        variant=five_bp_insertion_variant,
        seq_start_pos=5,
    ...
    six_bp_insertion_variant = Variant(
        "test-6bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GGGGGG"
    )
    six_bp_insertion = SeqEmbeddedVariant(
        variant=six_bp_insertion_variant,
        seq_start_pos=5,
    ...
    seven_bp_insertion_variant = Variant(
        "test-7bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GGGGGGG"
    )
    seven_bp_insertion = SeqEmbeddedVariant(
        variant=seven_bp_insertion_variant,
        seq_start_pos=5,
        seq_end_pos=11,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=7,
    )
    ...
    eight_bp_insertion_variant = Variant(
        "test-8bp-insertion", "X", 5116860, 5116861, genomic_alt_seq="GGGGGGGG"
    )
    eight_bp_insertion = SeqEmbeddedVariant(
        variant=eight_bp_insertion_variant,
        seq_start_pos=4,
        seq_end_pos=12,
        embedded_ref_seq_len=0,
        embedded_alt_seq_len=8,
    )
...
def test_translation_of_insertion_two_bp_in_codon() -> None:
    ...
    """
    one_bp_insertion_variant = Variant(
        "test-1bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="G"
    )
    one_bp_insertion = SeqEmbeddedVariant(
        variant=one_bp_insertion_variant,
        seq_start_pos=6,
    ...
    two_bp_insertion_variant = Variant(
        "test-2bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GG"
    )
    two_bp_insertion = SeqEmbeddedVariant(
        variant=two_bp_insertion_variant,
        seq_start_pos=6,
    ...
    three_bp_insertion_variant = Variant(
        "test-3bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GGG"
    )
    three_bp_insertion = SeqEmbeddedVariant(
        variant=three_bp_insertion_variant,
        seq_start_pos=6,
    ...
    four_bp_insertion_variant = Variant(
        "test-4bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GGGG"
    )
    four_bp_insertion = SeqEmbeddedVariant(
        variant=four_bp_insertion_variant,
        seq_start_pos=6,
    ...
    five_bp_insertion_variant = Variant(
        "test-5bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GGGGG"
    )
    five_bp_insertion = SeqEmbeddedVariant(
        variant=five_bp_insertion_variant,
        seq_start_pos=6,
    ...
    six_bp_insertion_variant = Variant(
        "test-6bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GGGGGG"
    )
    six_bp_insertion = SeqEmbeddedVariant(
        variant=six_bp_insertion_variant,
        seq_start_pos=6,
    ...
    seven_bp_insertion_variant = Variant(
        "test-7bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GGGGGGG"
    )
    seven_bp_insertion = SeqEmbeddedVariant(
        variant=seven_bp_insertion_variant,
        seq_start_pos=6,
    ...
    eight_bp_insertion_variant = Variant(
        "test-8bp-insertion", "X", 5116859, 5116860, genomic_alt_seq="GGGGGGGG"
    )
    eight_bp_insertion = SeqEmbeddedVariant(
        variant=eight_bp_insertion_variant,
        seq_start_pos=6,
...
def test_translation_of_complete_inframe_codon_deletion() -> None:
    ...
    """
    one_codon_deletion_variant = Variant(
        "test-one-codon-deletion", "X", 5116859, 5116861, genomic_ref_seq="CGT"
    )
    one_codon_deletion = SeqEmbeddedVariant(
        variant=one_codon_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=3,
    ...
    two_codon_deletion_variant = Variant(
        "test-two-codon-deletion", "X", 5116856, 5116861, genomic_ref_seq="GTGCGT"
    )
    two_codon_deletion = SeqEmbeddedVariant(
        variant=two_codon_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=6,
        embedded_alt_seq_len=0,
    )
...
def test_translation_of_cross_region_complete_inframe_codon_deletion(
...
def test_translation_of_deletion_one_bp_in_codon() -> None:
    ...
    """
    one_bp_deletion_variant = Variant(
        "test-1bp-deletion", "X", 5116861, 5116861, genomic_ref_seq="T"
    )
    one_bp_deletion = SeqEmbeddedVariant(
        variant=one_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=1,
        embedded_alt_seq_len=0,
    ...
    two_bp_deletion_variant = Variant(
        "test-2bp-deletion", "X", 5116860, 5116861, genomic_ref_seq="GT"
    )
    two_bp_deletion = SeqEmbeddedVariant(
        variant=two_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=2,
        embedded_alt_seq_len=0,
    )
    ...
    three_bp_deletion_variant = Variant(
        "test-3bp-deletion", "X", 5116859, 5116861, genomic_ref_seq="CGT"
    )
    three_bp_deletion = SeqEmbeddedVariant(
        variant=three_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=3,
        embedded_alt_seq_len=0,
    ...
    four_bp_deletion_variant = Variant(
        "test-4bp-deletion", "X", 5116858, 5116861, genomic_ref_seq="CCGT"
    )
    four_bp_deletion = SeqEmbeddedVariant(
        variant=four_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=4,
        embedded_alt_seq_len=0,
    )
    ...
    five_bp_deletion_variant = Variant(
        "test-5bp-deletion", "X", 5116857, 5116861, genomic_ref_seq="ACCGT"
    )
    five_bp_deletion = SeqEmbeddedVariant(
        variant=five_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=5,
        embedded_alt_seq_len=0,
    )
    ...
    six_bp_deletion_variant = Variant(
        "test-6bp-deletion", "X", 5116856, 5116861, genomic_ref_seq="CACCGT"
    )
    six_bp_deletion = SeqEmbeddedVariant(
        variant=six_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=6,
        embedded_alt_seq_len=0,
    ...
    seven_bp_deletion_variant = Variant(
        "test-1bp-deletion", "X", 5116855, 5116861, genomic_ref_seq="CCACCGT"
    )
    seven_bp_deletion = SeqEmbeddedVariant(
        variant=seven_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=7,
        embedded_alt_seq_len=0,
    )
    ...
    eight_bp_deletion_variant = Variant(
        "test-1bp-deletion", "X", 5116854, 5116861, genomic_ref_seq="CCCACCGT"
    )
    eight_bp_deletion = SeqEmbeddedVariant(
        variant=eight_bp_deletion_variant,
        seq_start_pos=3,
        seq_end_pos=4,
        embedded_ref_seq_len=8,
        embedded_alt_seq_len=0,
    )
...
def test_translation_of_deletion_two_bp_in_codon() -> None:
    ...
    """
    one_bp_deletion_variant = Variant(
        "test-1bp-deletion", "X", 5116860, 5116860, genomic_ref_seq="G"
    )
    one_bp_deletion = SeqEmbeddedVariant(
        variant=one_bp_deletion_variant,
        seq_start_pos=4,
    ...
    two_bp_deletion_variant = Variant(
        "test-2bp-deletion", "X", 5116859, 5116860, genomic_ref_seq="CG"
    )
    two_bp_deletion = SeqEmbeddedVariant(
        variant=two_bp_deletion_variant,
        seq_start_pos=4,
    ...
    three_bp_deletion_variant = Variant(
        "test-3bp-deletion", "X", 5116858, 5116860, genomic_ref_seq="CCG"
    )
    three_bp_deletion = SeqEmbeddedVariant(
        variant=three_bp_deletion_variant,
        seq_start_pos=4,
    ...
    four_bp_deletion_variant = Variant(
        "test-4bp-deletion", "X", 5116857, 5116860, genomic_ref_seq="ACCG"
    )
    four_bp_deletion = SeqEmbeddedVariant(
        variant=four_bp_deletion_variant,
        seq_start_pos=4,
    ...
    five_bp_deletion_variant = Variant(
        "test-5bp-deletion", "X", 5116856, 5116860, genomic_ref_seq="CACCG"
    )
    five_bp_deletion = SeqEmbeddedVariant(
        variant=five_bp_deletion_variant,
        seq_start_pos=4,
    ...
    six_bp_deletion_variant = Variant(
        "test-6bp-deletion", "X", 5116855, 5116860, genomic_ref_seq="CCACCG"
    )
    six_bp_deletion = SeqEmbeddedVariant(
        variant=six_bp_deletion_variant,
        seq_start_pos=4,
    ...
    seven_bp_deletion_variant = Variant(
        "test-7bp-deletion", "X", 5116854, 5116860, genomic_ref_seq="CCCACCG"
    )
    seven_bp_deletion = SeqEmbeddedVariant(
        variant=seven_bp_deletion_variant,
        seq_start_pos=4,
    ...
    eight_bp_deletion_variant = Variant(
        "test-8bp-deletion", "X", 5116853, 5116860, genomic_ref_seq="ACCCACCG"
    )
    eight_bp_deletion = SeqEmbeddedVariant(
        variant=eight_bp_deletion_variant,
        seq_start_pos=4,
...
def test_translation_of_deletion_three_bp_in_codon() -> None:
    ...
    one_bp_deletion_variant = Variant(
        "test-1bp-deletion", "X", 5116859, 5116859, genomic_ref_seq="C"
    )
    one_bp_deletion = SeqEmbeddedVariant(
        variant=one_bp_deletion_variant,
        seq_start_pos=5,
    ...
    two_bp_deletion_variant = Variant(
        "test-2bp-deletion", "X", 5116858, 5116859, genomic_ref_seq="CC"
    )
    two_bp_deletion = SeqEmbeddedVariant(
        variant=two_bp_deletion_variant,
        seq_start_pos=5,
    ...
    three_bp_deletion_variant = Variant(
        "test-3bp-deletion", "X", 5116857, 5116859, genomic_ref_seq="ACC"
    )
    three_bp_deletion = SeqEmbeddedVariant(
        variant=three_bp_deletion_variant,
        seq_start_pos=5,
    ...
    four_bp_deletion_variant = Variant(
        "test-4bp-deletion", "X", 5116856, 5116859, genomic_ref_seq="CACC"
    )
    four_bp_deletion = SeqEmbeddedVariant(
        variant=four_bp_deletion_variant,
        seq_start_pos=5,
    ...
    five_bp_deletion_variant = Variant(
        "test-5bp-deletion", "X", 5116855, 5116859, genomic_ref_seq="CCACC"
    )
    five_bp_deletion = SeqEmbeddedVariant(
        variant=five_bp_deletion_variant,
        seq_start_pos=5,
    ...
    six_bp_deletion_variant = Variant(
        "test-6bp-deletion", "X", 5116854, 5116859, genomic_ref_seq="CCCACC"
    )
    six_bp_deletion = SeqEmbeddedVariant(
        variant=six_bp_deletion_variant,
        seq_start_pos=5,
    ...
    seven_bp_deletion_variant = Variant(
        "test-7bp-deletion", "X", 5116853, 5116859, genomic_ref_seq="ACCCACC"
    )
    seven_bp_deletion = SeqEmbeddedVariant(
        variant=seven_bp_deletion_variant,
        seq_start_pos=5,
    ...
    eight_bp_deletion_variant = Variant(
        "test-7bp-deletion", "X", 5116853, 5116859, genomic_ref_seq="TACCCACC"
    )
    eight_bp_deletion = SeqEmbeddedVariant(
        variant=eight_bp_deletion_variant,
        seq_start_pos=5,
...
def test_translation_of_indel_deletion_within_one_codon() -> None:
    ...
    indel_deletion = SeqEmbeddedVariant(
        variant=indel_deletion_variant,
        seq_start_pos=5,
        seq_end_pos=6,
        embedded_ref_seq_len=2,
        embedded_alt_seq_len=1,
