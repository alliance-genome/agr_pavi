...
def test_alignment_embedded_variant_initiation_with_SeqRecord(
    wb_variant_yn32_in_C42D8_8a_1_protein_alignment,
) -> None:
    """
    Test AlignmentEmbeddedVariant class initiation using SeqRecord.
    """
    assert isinstance(
        wb_variant_yn32_in_C42D8_8a_1_protein_alignment, AlignmentEmbeddedVariant
    )
...
def test_alignment_embedded_variant_initiation_with_positions(
    wb_variant_yn32_in_C42D8_8a_1_protein_seq,
) -> None:
    """
    Test AlignmentEmbeddedVariant class initiation using positions.
    """
    alignment_embedded_w_positions = AlignmentEmbeddedVariant(
        embedded_variant=wb_variant_yn32_in_C42D8_8a_1_protein_seq,
...
def test_alignment_embedded_variant_from_dict(
    wb_variant_yn32_in_C42D8_8a_1_protein_alignment,
) -> None:
    """
    ...
    assert (
        alignment_embedded_from_dict == wb_variant_yn32_in_C42D8_8a_1_protein_alignment
    )


def test_alignment_embedded_variant_from_dict_initiation_errors(
    wb_variant_yn32,
) -> None:
    """
...
def test_alignment_embedded_deletion_w_flanking_bases(
    wb_variants_ok2799_in_k12g11_3_1_protein_alignment,
) -> None:
    """
