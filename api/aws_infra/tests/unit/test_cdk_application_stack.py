...
from cdk_classes.cdk_application_stack import CdkEBApplicationStack
...
app = App()
stack = CdkEBApplicationStack(app, "pytest-EBApplication-stack", env=agr_aws_environment)
...
def test_eb_application() -> None:
    template.has_resource(type=ResourceType.ELASTIC_BEANSTALK_APPLICATION.compliance_resource_type, props={
        "Properties": {
