...
ApiImageRepoCdkStack(app, "PaviApiImageRepoCdkStack", env=agr_aws_environment)
...
if deployment_method == "fargate":
    ...
    eb_app_stack = ApiEbApplicationCdkStack(
        app, "PaviApiEbApplicationCdkStack", env=agr_aws_environment
    )
