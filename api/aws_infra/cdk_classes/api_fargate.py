...
class ApiFargateStack(Stack):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Get ECR repository
        ecr_repo_name = "agr_pavi/pavi_api"
        ...
        self.service = ecs_patterns.ApplicationLoadBalancedFargateService(
            ...
            task_image_options=ecs_patterns.ApplicationLoadBalancedTaskImageOptions(
                ...
                log_driver=ecs.LogDrivers.aws_logs(
                    stream_prefix="pavi-api", log_group=log_group
                ),
            ),
        ...
        if custom_domain:
            ...
            hosted_zone = route53.HostedZone.from_lookup(
                self, "hosted-zone", domain_name="alliancegenome.org", private_zone=True
            )

            # Create CNAME record
            route53.CnameRecord(
                self,
                f"pavi-api-cname-{env_suffix}",
                zone=hosted_zone,
