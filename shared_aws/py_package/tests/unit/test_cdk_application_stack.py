...
class PyTestEbEnvironment(Stack):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.extra_option_setting_properties: list[
...
eb_app_stack = EBApplicationCdkStack(
    app,
    "pytest-test-EB-Application-stack",
...
eb_env_stack = PyTestEbEnvironment(
    app,
    "pytest-testcomponent-env-stack",
    "pytest",
    eb_app_stack,
    env=agr_aws_environment,
)
...
def test_eb_application() -> None:
    eb_app_template.has_resource(
        ...
        props={"Properties": {"ApplicationName": "PAVI-testcomponent"}},
    )
...
def test_eb_app_environment_output() -> None:
    eb_env_template.has_output(
        ...
        props={
            "Export": {"Name": "pytest-testcomponent-env-stack:endpointUrl"},
    ...
    eb_env_template.has_output(
        ...
        props={
            "Export": {"Name": "pytest-testcomponent-env-stack:ebEnvironmentName"},
